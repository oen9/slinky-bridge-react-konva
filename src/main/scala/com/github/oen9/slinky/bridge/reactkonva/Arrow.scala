...
@react object Arrow extends ExternalComponentWithRefType[Operations.ShapeRef] {
  case class Props(
    // Arrow
    points: js.UndefOr[Seq[Double]] = js.undefined,
    ...
    pointerAtBeginning: js.UndefOr[Boolean] = js.undefined,
